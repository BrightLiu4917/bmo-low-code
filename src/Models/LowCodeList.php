...
//        NewEloquentBuilder,
    ...
    protected $casts = [
        ...
        'list_type' => 'integer',
        // Assuming it's an integer type, adjust if necessary

        'admin_name'         => 'string',
        // Assuming it's a string type, adjust if necessary
        'family_doctor_name' => 'string',
        // Assuming it's a string type, adjust if necessary
        'mobile_doctor_name' => 'string',
        // Assuming it's a string type, adjust if necessary

        'admin_weight'         => 'integer',
        // Assuming it's an integer type, adjust if necessary
        'family_doctor_weight' => 'integer',
        // Assuming it's an integer type, adjust if necessary
        'mobile_doctor_weight' => 'integer',
        // Assuming it's an integer type, adjust if necessary

        'crowd_type_code'          => 'string',
        // varchar(32) NOT NULL DEFAULT ''
        'template_code_filter'     => 'string',
        // Assuming it's a string type, adjust if necessary
        'template_code_column'     => 'string',
        // Assuming it's a string type, adjust if necessary
        'template_code_field'      => 'string',
        // Assuming it's a string type, adjust if necessary
        'template_code_button'     => 'string',
        // Assuming it's a string type, adjust if necessary
        'template_code_top_button' => 'string',
        // Assuming it's a string type, adjust if necessary
